import type { ExerciseInformation, PlannedWorkout } from "@/lib/types/Workout";
...
export const dummyExercise: ExerciseInformation = {
  exerciseId: "bench_press_001",
  name: "Barbell Bench Press",
  description:
  ...
  tutorialUrl: "https://www.youtube.com/watch?v=gRVjAtPip0Y",
  instructions: [
    "Lie on the bench with feet planted, back neutral, and eyes under the barbell",
    "Grip the bar slightly wider than shoulder width and squeeze shoulder blades together",
    "Unrack the bar and lower it under control to mid-chest while keeping elbows at ~45°",
    "Pause briefly, then drive the bar upward by pressing through the chest and triceps",
    "Lock out with arms straight, maintain tension, then repeat for the prescribed reps",
  ],
};
