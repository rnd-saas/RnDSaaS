...
const buttonVariants = cva(
    ...
    "font-[var(--button-font-weight)] text-[var(--button-font-size)] font-[var(--button-font-family)] leading-[var(--button-line-height)] tracking-[var(--button-letter-spacing)]",
  {
    variants: {
      variant: {
        default:
          "bg-[var(--color-primary)] text-[var(--color-background)] hover:bg-[var(--color-primary-hover)] active:bg-[var(--color-primary-pressed)] disabled:bg-[var(--color-primary-disabled)]",
        destructive:
          "bg-destructive text-white hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60",
        outline:
          "border bg-background shadow-xs hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50",
        secondary:
            "bg-[var(--color-secondary)] text-[var(--color-grey-text)] hover:bg-[var(--color-secondary-hover)] active:bg-[var(--color-secondary-pressed)] disabled:bg-[var(--color-secondary-disabled)] disabled:text-[var(--color-background)]",
        ghost:
          "hover:bg-accent hover:text-accent-foreground dark:hover:bg-accent/50",
        link:
            "text-[var(--color-link)] underline-offset-4 hover:underline active:text-[var(--intuitive-names-secondary-text)]",
      },
      size: {
